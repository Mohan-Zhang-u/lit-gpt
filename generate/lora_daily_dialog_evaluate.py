...
from scripts.prepare_daily_dialog import generate_prompt
...
def main(
    ...
    data_dir="data/alpaca" # hardcode for now
    train_data = torch.load("data/alpaca/train.pt")
    val_data = torch.load("data/alpaca/val.pt")
    test_data = torch.load("data/alpaca/test.pt")
